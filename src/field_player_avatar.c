...
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_DELTA_BRENDAN,            OBJ_EVENT_GFX_DELTA_MAY},
    [PLAYER_AVATAR_STATE_MACH_BIKE]  = {OBJ_EVENT_GFX_DELTA_BRENDAN_MACH_BIKE,  OBJ_EVENT_GFX_DELTA_MAY_MACH_BIKE},
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_DELTA_BRENDAN_ACRO_BIKE,  OBJ_EVENT_GFX_DELTA_MAY_ACRO_BIKE},
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_DELTA_BRENDAN_SURFING,    OBJ_EVENT_GFX_DELTA_MAY_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_DELTA_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_DELTA_MAY_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_DELTA_BRENDAN_FIELD_MOVE, OBJ_EVENT_GFX_DELTA_MAY_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_DELTA_BRENDAN_FISHING,    OBJ_EVENT_GFX_DELTA_MAY_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_DELTA_BRENDAN_WATERING,   OBJ_EVENT_GFX_DELTA_MAY_WATERING},
...
static const u16 sPlayerAvatarGfxToStateFlag[GENDER_COUNT][5][2] =
{
    [MALE] =
    {
        {OBJ_EVENT_GFX_DELTA_BRENDAN,            PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_DELTA_BRENDAN_MACH_BIKE,  PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_DELTA_BRENDAN_ACRO_BIKE,  PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_DELTA_BRENDAN_SURFING,    PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_DELTA_BRENDAN_UNDERWATER, PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [FEMALE] =
    {
        {OBJ_EVENT_GFX_DELTA_MAY,              PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_DELTA_MAY_MACH_BIKE,    PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_DELTA_MAY_ACRO_BIKE,    PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_DELTA_MAY_SURFING,      PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_DELTA_MAY_UNDERWATER,   PLAYER_AVATAR_FLAG_UNDERWATER},
    }
};
...
u8 GetPlayerAvatarGenderByGraphicsId(u16 gfxId)
{
    switch (gfxId)
    {
    case OBJ_EVENT_GFX_DELTA_MAY:
    case OBJ_EVENT_GFX_DELTA_MAY_MACH_BIKE:
    case OBJ_EVENT_GFX_DELTA_MAY_ACRO_BIKE:
    case OBJ_EVENT_GFX_DELTA_MAY_SURFING:
    case OBJ_EVENT_GFX_DELTA_MAY_FIELD_MOVE:
    case OBJ_EVENT_GFX_DELTA_MAY_UNDERWATER:
    case OBJ_EVENT_GFX_DELTA_MAY_FISHING:
    case OBJ_EVENT_GFX_DELTA_MAY_WATERING:
        return FEMALE;
    default:
        return MALE;
    }
...
// now always get on hook; 7/20/24
