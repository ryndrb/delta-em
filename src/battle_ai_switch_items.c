...
static bool32 FindMonThatAbsorbsOpponentsMove(u32 battler)
{
    ...
    else if (predictedType == TYPE_POISON || (isOpposingBattlerChargingOrInvulnerable && incomingType == TYPE_POISON))
    {
        absorbingTypeAbilities[numAbsorbingAbilities++] = ABILITY_POISON_ABSORB;
    }
