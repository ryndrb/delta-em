...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_DEWFORD_MANOR - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    ...
    [MAPSEC_MIRAGE_RUINS - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
};
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_MIRAGE_RUINS - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
};
