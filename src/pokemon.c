        ...
        for (i = 0; evolutions[i].method != EVOLUTIONS_END; i++)
        {
            ...
            case EVO_ITEM:
                ...
                if (evolutions[i].param == evolutionItem) {
                    // Get a random type from *_SWEET
                    if (species == SPECIES_MILCERY && evolutionItem >= ITEM_STRAWBERRY_SWEET && evolutionItem <= ITEM_RIBBON_SWEET)
                        targetSpecies = GetAlcremieFormBySweetType(evolutionItem);
                    else
                        targetSpecies = evolutions[i].targetSpecies;
                }
                break;
...
const u8 *GetTrainerPartnerName(void)
{
    ...
    {
        if (gPartnerTrainerId == TRAINER_PARTNER(PARTNER_STEVEN_SOUTHERN_ISLAND))
        {
            return GetTrainerNameFromId(PARTNER_STEVEN_SOUTHERN_ISLAND);
        }
        else if (gPartnerTrainerId == TRAINER_PARTNER(PARTNER_STEVEN_MOSSDEEP_SPACE_CENTER))
        {
            return GetTrainerNameFromId(PARTNER_STEVEN_MOSSDEEP_SPACE_CENTER);
        }
        else
        {
...
u16 GetAlcremieFormBySweetType(u16 evolutionItem) {
    static const u16 alcremieForms[][9] = {
        {SPECIES_ALCREMIE_STRAWBERRY_VANILLA_CREAM, SPECIES_ALCREMIE_STRAWBERRY_RUBY_CREAM, SPECIES_ALCREMIE_STRAWBERRY_MATCHA_CREAM,
         SPECIES_ALCREMIE_STRAWBERRY_SALTED_CREAM, SPECIES_ALCREMIE_STRAWBERRY_LEMON_CREAM, SPECIES_ALCREMIE_STRAWBERRY_MINT_CREAM,
         SPECIES_ALCREMIE_STRAWBERRY_CARAMEL_SWIRL, SPECIES_ALCREMIE_STRAWBERRY_RUBY_SWIRL, SPECIES_ALCREMIE_STRAWBERRY_RAINBOW_SWIRL},

        {SPECIES_ALCREMIE_FLOWER_VANILLA_CREAM, SPECIES_ALCREMIE_FLOWER_RUBY_CREAM, SPECIES_ALCREMIE_FLOWER_MATCHA_CREAM,
         SPECIES_ALCREMIE_FLOWER_SALTED_CREAM, SPECIES_ALCREMIE_FLOWER_LEMON_CREAM, SPECIES_ALCREMIE_FLOWER_MINT_CREAM,
         SPECIES_ALCREMIE_FLOWER_CARAMEL_SWIRL, SPECIES_ALCREMIE_FLOWER_RUBY_SWIRL, SPECIES_ALCREMIE_FLOWER_RAINBOW_SWIRL},

        {SPECIES_ALCREMIE_STAR_VANILLA_CREAM, SPECIES_ALCREMIE_STAR_RUBY_CREAM, SPECIES_ALCREMIE_STAR_MATCHA_CREAM,
         SPECIES_ALCREMIE_STAR_SALTED_CREAM, SPECIES_ALCREMIE_STAR_LEMON_CREAM, SPECIES_ALCREMIE_STAR_MINT_CREAM,
         SPECIES_ALCREMIE_STAR_CARAMEL_SWIRL, SPECIES_ALCREMIE_STAR_RUBY_SWIRL, SPECIES_ALCREMIE_STAR_RAINBOW_SWIRL},

        {SPECIES_ALCREMIE_CLOVER_VANILLA_CREAM, SPECIES_ALCREMIE_CLOVER_RUBY_CREAM, SPECIES_ALCREMIE_CLOVER_MATCHA_CREAM,
         SPECIES_ALCREMIE_CLOVER_SALTED_CREAM, SPECIES_ALCREMIE_CLOVER_LEMON_CREAM, SPECIES_ALCREMIE_CLOVER_MINT_CREAM,
         SPECIES_ALCREMIE_CLOVER_CARAMEL_SWIRL, SPECIES_ALCREMIE_CLOVER_RUBY_SWIRL, SPECIES_ALCREMIE_CLOVER_RAINBOW_SWIRL},

        {SPECIES_ALCREMIE_BERRY_VANILLA_CREAM, SPECIES_ALCREMIE_BERRY_RUBY_CREAM, SPECIES_ALCREMIE_BERRY_MATCHA_CREAM,
         SPECIES_ALCREMIE_BERRY_SALTED_CREAM, SPECIES_ALCREMIE_BERRY_LEMON_CREAM, SPECIES_ALCREMIE_BERRY_MINT_CREAM,
         SPECIES_ALCREMIE_BERRY_CARAMEL_SWIRL, SPECIES_ALCREMIE_BERRY_RUBY_SWIRL, SPECIES_ALCREMIE_BERRY_RAINBOW_SWIRL},

        {SPECIES_ALCREMIE_RIBBON_VANILLA_CREAM, SPECIES_ALCREMIE_RIBBON_RUBY_CREAM, SPECIES_ALCREMIE_RIBBON_MATCHA_CREAM,
         SPECIES_ALCREMIE_RIBBON_SALTED_CREAM, SPECIES_ALCREMIE_RIBBON_LEMON_CREAM, SPECIES_ALCREMIE_RIBBON_MINT_CREAM,
         SPECIES_ALCREMIE_RIBBON_CARAMEL_SWIRL, SPECIES_ALCREMIE_RIBBON_RUBY_SWIRL, SPECIES_ALCREMIE_RIBBON_RAINBOW_SWIRL},

        {SPECIES_ALCREMIE_LOVE_VANILLA_CREAM, SPECIES_ALCREMIE_LOVE_RUBY_CREAM, SPECIES_ALCREMIE_LOVE_MATCHA_CREAM,
         SPECIES_ALCREMIE_LOVE_SALTED_CREAM, SPECIES_ALCREMIE_LOVE_LEMON_CREAM, SPECIES_ALCREMIE_LOVE_MINT_CREAM,
         SPECIES_ALCREMIE_LOVE_CARAMEL_SWIRL, SPECIES_ALCREMIE_LOVE_RUBY_SWIRL, SPECIES_ALCREMIE_LOVE_RAINBOW_SWIRL},
    };

    u16 itemIndex = 0;
    switch (evolutionItem) {
        case ITEM_STRAWBERRY_SWEET: itemIndex = 0; break;
        case ITEM_FLOWER_SWEET:     itemIndex = 1; break;
        case ITEM_STAR_SWEET:       itemIndex = 2; break;
        case ITEM_CLOVER_SWEET:     itemIndex = 3; break;
        case ITEM_BERRY_SWEET:      itemIndex = 4; break;
        case ITEM_RIBBON_SWEET:     itemIndex = 5; break;
        case ITEM_LOVE_SWEET:       itemIndex = 6; break;
        default: return 0;
    }

    return alcremieForms[itemIndex][Random() % (sizeof(alcremieForms[itemIndex]) / sizeof(alcremieForms[itemIndex][0]))];
}
