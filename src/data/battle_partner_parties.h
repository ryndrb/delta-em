static const struct TrainerMon sParty_MayMeteorFallsTreeckoPartner[] = {
    {
        .lvl = 42,
...
static const struct TrainerMon sParty_MayMeteorFallsTorchicPartner[] = {
    {
        .lvl = 42,
...
static const struct TrainerMon sParty_MayMeteorFallsMudkipPartner[] = {
    {
        .lvl = 42,
...
static const struct TrainerMon sParty_BrendanMeteorFallsTreeckoPartner[] = {
    {
        .lvl = 42,
        .species = SPECIES_BLAZIKEN,
        .ability = ABILITY_SPEED_BOOST,
...
static const struct TrainerMon sParty_BrendanMeteorFallsTorchicPartner[] = {
    {
        .lvl = 42,
        .species = SPECIES_SWAMPERT,
        .ability = ABILITY_STAMINA,
...
static const struct TrainerMon sParty_BrendanMeteorFallsMudkipPartner[] = {
    {
        .lvl = 42,
        .species = SPECIES_SCEPTILE,
        .ability = ABILITY_SHARPNESS,
...
static const struct TrainerMon sParty_StevenSouthernIslandPartner[] = {
    {
        .lvl = 52,
...
static const struct TrainerMon sParty_StevenMossdeepSpaceCenterPartner[] = {
    {
