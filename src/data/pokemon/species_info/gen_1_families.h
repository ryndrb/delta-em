...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_CHARMANDER] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_COMPETITIVE, ABILITY_SOLAR_POWER },
...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 101 : 91)
    ...
    [SPECIES_PIKACHU] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU, CONDITIONS({IF_NOT_REGION, REGION_ALOLA})},
                                {EVO_ITEM, ITEM_SUN_STONE, SPECIES_RAICHU_ALOLA, CONDITIONS({IF_REGION, REGION_ALOLA})}),
    },
...
#define WIGGLYTUFF_SP_ATK   50
    ...
    [SPECIES_WIGGLYTUFF] =
    {
        ...
        .baseDefense   = 45,
        .baseSpeed     = 45,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_6 ? 110 : 75,
        .baseSpDefense = 50,
        .types = JIGGLYPUFF_FAMILY_TYPES,
        .catchRate = 50,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
    ...
    [SPECIES_ODDISH] =
    {
        ...
        .abilities = { ABILITY_CHLOROPHYLL , ABILITY_THICK_FAT, ABILITY_EFFECT_SPORE },
        .bodyColor = BODY_COLOR_BLUE,
...
#define DUGTRIO_ATTACK (P_UPDATED_STATS >= GEN_7 ? 115 : 80)
    ...
    [SPECIES_ANNIHILAPE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_DEFIANT, ABILITY_INNER_FOCUS, ABILITY_ADRENALINE },
        .bodyColor = BODY_COLOR_GRAY,
...
#define ALAKAZAM_SP_DEF 135
    ...
    [SPECIES_VICTREEBEL] =
    {
        ...
        .baseSpeed     = 70,
        .baseSpAttack  = 110,
        .baseSpDefense = P_UPDATED_STATS >= GEN_6 ? 60 : 60,
        .types = MON_TYPES(TYPE_GRASS, TYPE_POISON),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 245,
    ...
    [SPECIES_TENTACOOL] =
    {
        ...
        .abilities = { ABILITY_RAIN_DISH, ABILITY_LIQUID_OOZE, ABILITY_POISON_TOUCH },
        .bodyColor = BODY_COLOR_BLUE,
...
#define FARFETCHD_ATTACK (P_UPDATED_STATS >= GEN_7 ? 115 : 65)
...
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_LEVITATE}
#else
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE}
    ...
    [SPECIES_VOLTORB] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SOUNDPROOF, ABILITY_VOLT_ABSORB, ABILITY_AFTERMATH },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_EXEGGCUTE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR, CONDITIONS({IF_NOT_REGION, REGION_ALOLA})},
                                {EVO_ITEM, ITEM_SUN_STONE, SPECIES_EXEGGUTOR_ALOLA, CONDITIONS({IF_REGION, REGION_ALOLA})}),
    },
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 95 : 65)
    ...
    [SPECIES_EXEGGUTOR_ALOLA] =
    {
        ...
        .baseSpeed     = 45,
        .baseSpAttack  = 135,
        .baseSpDefense = EXEGGUTOR_SP_DEF + 10,
    ...
    [SPECIES_MAROWAK_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_LIGHTNING_ROD, ABILITY_CURSED_BODY },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Marowak"),
        .cryId = CRY_MAROWAK,
        .natDexNum = NATIONAL_DEX_MAROWAK,
    ...
    [SPECIES_MIME_JR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_MR_MIME, CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD})},
    ...
    [SPECIES_TAUROS_PALDEA_COMBAT] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_ADRENALINE, ABILITY_CUD_CHEW },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Tauros"),
        .cryId = CRY_TAUROS,
        .natDexNum = NATIONAL_DEX_TAUROS,
    ...
    [SPECIES_MUNCHLAX] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PICKUP, ABILITY_THICK_FAT, ABILITY_FLUFFY },
        .bodyColor = BODY_COLOR_BLACK,
