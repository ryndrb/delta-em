...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_LEDIAN] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_EARLY_BIRD, ABILITY_POWER_FIST },
        .bodyColor = BODY_COLOR_RED,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 100 : 75)
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_URSALUNA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_PEAT_BLOCK, SPECIES_URSALUNA_BLOODMOON, CONDITIONS({IF_TIME, TIME_NIGHT})}),
    },
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 105 : 85)
    ...
    [SPECIES_RAIKOU] =
    {
        ...
        .abilities = { ABILITY_PRESSURE, ABILITY_PRESSURE, ABILITY_VOLT_ABSORB },
    #else
    ...
    [SPECIES_ENTEI] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_7
        .abilities = { ABILITY_PRESSURE, ABILITY_PRESSURE, ABILITY_FLASH_FIRE },
    #else
    ...
    [SPECIES_SUICUNE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_7
        .abilities = { ABILITY_PRESSURE, ABILITY_PRESSURE, ABILITY_WATER_ABSORB },
    #else
