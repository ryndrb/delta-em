...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_YAMPER] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BALL_FETCH, ABILITY_ADRENALINE, ABILITY_RATTLED },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_BOLTUND] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STRONG_JAW, ABILITY_ADRENALINE, ABILITY_COMPETITIVE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_GRIMMSNARL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_PRANKSTER, ABILITY_FRISK, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_PURPLE,
...
#define ALCREMIE_REGULAR_SPECIES_INFO(sweet, cream, color)                                      \
    ...
    [SPECIES_SNOM] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 49, SPECIES_FROSMOTH}),
    },
    ...
    {
        .baseHP        = 92,
        .baseAttack    = P_UPDATED_STATS >= GEN_9 ? 170 : 170,
        .baseDefense   = 115,
        .baseSpeed     = 148,
        .baseSpAttack  = 80,
        .baseSpDefense = 115,
    ...
    [SPECIES_ZAMAZENTA_CROWNED] =
    {
        .baseHP        = 92,
        .baseAttack    = P_UPDATED_STATS >= GEN_9 ? 130 : 130,
        .baseDefense   = P_UPDATED_STATS >= GEN_9 ? 145 : 145,
        .baseSpeed     = 128,
        .baseSpAttack  = 80,
        .baseSpDefense = P_UPDATED_STATS >= GEN_9 ? 145 : 145,
