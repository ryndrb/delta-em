...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_MILCERY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_STRAWBERRY_SWEET, SPECIES_ALCREMIE_STRAWBERRY_VANILLA_CREAM},
                                {EVO_ITEM, ITEM_FLOWER_SWEET, SPECIES_ALCREMIE_STRAWBERRY_RUBY_CREAM},
                                {EVO_ITEM, ITEM_STAR_SWEET, SPECIES_ALCREMIE_STRAWBERRY_MATCHA_CREAM},
                                {EVO_ITEM, ITEM_CLOVER_SWEET, SPECIES_ALCREMIE_STRAWBERRY_MINT_CREAM},
                                {EVO_ITEM, ITEM_BERRY_SWEET, SPECIES_ALCREMIE_STRAWBERRY_LEMON_CREAM},
                                {EVO_ITEM, ITEM_RIBBON_SWEET, SPECIES_ALCREMIE_STRAWBERRY_SALTED_CREAM},
                                {EVO_ITEM, ITEM_LOVE_SWEET, SPECIES_ALCREMIE_STRAWBERRY_RUBY_SWIRL}),
                                // {EVO_ITEM, ITEM__SWEET, SPECIES_ALCREMIE_STRAWBERRY_CARAMEL_SWIRL},
                                // {EVO_ITEM, ITEM__SWEET, SPECIES_ALCREMIE_STRAWBERRY_RAINBOW_SWIRL}),
    },
