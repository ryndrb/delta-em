...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_VIGOROTH] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ADRENALINE, ABILITY_ADRENALINE, ABILITY_ADRENALINE },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_EXPLOUD] =
    {
        ...
        .baseSpeed     = 68,
        .baseSpAttack  = 101,
        .baseSpDefense = P_UPDATED_STATS >= GEN_6 ? 63 : 63,
        .types = MON_TYPES(TYPE_NORMAL),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 245,
    ...
    [SPECIES_ALTARIA] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_LEVITATE, ABILITY_COTTON_DOWN, ABILITY_CLOUD_NINE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_ZANGOOSE] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_IMMUNITY, ABILITY_TOXIC_BOOST, ABILITY_FATAL_PRECISION },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_SEVIPER] =
    {
        ...
        .abilities = { ABILITY_SHED_SKIN, ABILITY_INFILTRATOR, ABILITY_FATAL_PRECISION },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_LEVITATE, ABILITY_HARVEST },
    #else
    ...
    [SPECIES_BELDUM] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_FULL_METAL_BODY, ABILITY_FATAL_PRECISION },
        .bodyColor = BODY_COLOR_BLUE,
