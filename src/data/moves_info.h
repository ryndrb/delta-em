...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_WILD_CHARGE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Attacks in a cloak of electricity\n"
            "and smashes into foe."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_MYSTICAL_FIRE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "fire. Lowers Sp. Atk."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_7 ? 85 : 65,
        .type = TYPE_FIRE,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
