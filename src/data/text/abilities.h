...
static const u8 sDampDescription[] = _("Prevents the use of self-\n-destructing moves. Takes 1/2\ndamage from sound moves.");
...
static const u8 sIlluminateDescription[] = _("This Pokémon receives 1/2\ndamage from Dark moves and\nboost accuracy by 1.2x.");
...
static const u8 sInnerFocusDescription[] = _("This Pokémon cannot be made\nto flinch. Boost accuracy by\n1.1x; Immune to Intimidate.");
...
static const u8 sRunAwayDescription[] = _("This Pokémon can switch out\neven when trapped by another\nPokémon's ability.");
...
static const u8 sShedSkinDescription[] = _("This Pokémon has a 50% chance\nto have its status cured at\nthe end of each turn.");
...
static const u8 sAftermathDescription[] = _("If this Pokémon is KOed with\nany move, that move's user\nloses 1/4 its max HP.");
...
static const u8 sStormDrainDescription[] = _("This Pokémon draws Water\nmoves to itself to raise its\nhigher attacking stat by 1.");
...
#endif
static const u8 sHoneyGatherDescription[] = _("This Pokémon has a 25%\nchance to heal itself by 1/2\nof it's max HP per turn.");
...
static const u8 sFlareBoostDescription[] = _("While this Pokémon is poisoned,\nits Sp. Attack and Speed are\nmultiplied by 1.3x.");
...
static const u8 sCorrosionDescription[] = _("This Pokémon can poison a\nfoe regardless of its typing.\nSuper-effective against Steel.");
