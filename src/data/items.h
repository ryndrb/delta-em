...
#define TREASURE_FACTOR ((I_SELL_VALUE_FRACTION >= GEN_9) ? 1 : 1)
...
static const u8 sGenericTMHMDesc[]    = _("This item teaches\n"
                                          "a Pokémon the move\n"
                                          "{STR_VAR_2}.");
...
// Misc. Held Items
    ...
    [ITEM_SHED_SHELL] =
    {
        ...
        .price = (I_PRICE >= GEN_9) ? 1000 : ((I_PRICE >= GEN_7) ? 4000 : 100),
...
// GEN 9 ITEMS
    ...
    {
        .name = ITEM_NAME("Intriguing Stone"),
        .price = 100000,
        .description = COMPOUND_STRING(
            "A rather curious\n"
            "stone."),
        ...
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .iconPic = gItemIcon_IntriguingStone,
        .iconPalette = gItemIconPalette_IntriguingStone,
    },
};
