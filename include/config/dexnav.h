...
// Flag/var defines
#define DN_FLAG_SEARCHING             FLAG_SYS_DEXNAV_SEARCH_ // Searching for mon
#define DN_FLAG_DEXNAV_GET            FLAG_SYS_DEXNAV_GET_ // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         FLAG_SYS_DETECTOR_MODE_ // Allow player to find hidden mons
#define DN_VAR_SPECIES                VAR_DEXNAV_SPECIES_ // Registered DexNav species
#define DN_VAR_STEP_COUNTER           VAR_DEXNAV_STEP_COUNTER_ // Steps for finding hidden pokemon
