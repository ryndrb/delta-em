...
// Flag/var defines
#define FLAG_SYS_DEXNAV_SEARCH          FLAG_SYS_DEXNAV_SEARCH_ // Searching for mon
#define FLAG_SYS_DEXNAV_GET             FLAG_SYS_DEXNAV_GET_ // DexNav shows in start menu
#define FLAG_SYS_DETECTOR_MODE          FLAG_SYS_DETECTOR_MODE_ // Allow player to find hidden mons
#define VAR_DEXNAV_SPECIES              VAR_DEXNAV_SPECIES_ // Registered DexNav species
#define VAR_DEXNAV_STEP_COUNTER         VAR_DEXNAV_STEP_COUNTER_ // Steps for finding hidden pokemon
